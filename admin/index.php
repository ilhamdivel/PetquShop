...
<head>
    ...
    <title>Admin Panel - PetquShop</title>
                ...
                <div class="menu-inner">
                    <nav>
						...
						<li>
												...
												<li>
													<a href="../"><span>Kembali ke Toko</span></a>
												</li>
                            ...
                            <a href="manageorder.php"><i class="ti-dashboard"></i><span>Kelola Pesanan<span></a>
												...
												<li>
                                                <a href="produk.php" ><i class="ti-layout"></i><span>Kelola Produk</span></a>
                        </li>

												<li>
													<a href="customer.php"><span>Kelola Pelanggan</span></a>
												</li>

												<li >
													<a href="user.php"><span>Kelola Staff</span></a></li>
                        <li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    Anda Login sebagai <strong><?php echo $_SESSION['name'] ?></strong>
									<br>
